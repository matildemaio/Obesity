...
Obesity 26-05-2025 Group: Tutorial 4 Tutorial lecturer: Chantal Students: Renata Mutesah (2797482), Jada van Heyningen (2801118), Matilde Maio (2861974), Eren Murtezaoglu (2819813)
...
#Part 2: Data Sourcing (may need to edit this later- Ask tutroial teacher: do i just copy and paste the whole link or do i need to somehow download the data?) income_2019 \<- read_csv("path/to/income_2019.csv") income_2021 \<- read_csv("path/to/income_2021.csv") income_2022 \<- read_csv("path/to/income_2022.csv")
